...
export function AppHeader({ breadcrumbs = [] }: AppHeaderProps) {
    ...
    return (
        <>
            <div className="border-b border-slate-200/80 dark:border-slate-700/80 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="flex h-full w-64 flex-col items-stretch justify-between bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm">
            ...
            {breadcrumbs.length > 1 && (
                <div className="flex w-full border-b border-slate-200/70 dark:border-slate-700/70 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm">
